...
#        fw_logits[0] = (logits[0] + self.initial.loggeomean().unsqueeze(-1)).logsumexp(-2)
    ...
    def update_markov_parms(self,lr=1.0,beta=None):
        self.transition.ss_update(self.SEzz,lr=lr,beta=beta)
        self.initial.ss_update(self.SEz0,lr=lr,beta=beta)
    ...
    def update(self,X,iters=1,lr=1.0,beta=None,verbose=False):   
        ...
        for i in range(iters):
            ...
            self.update_markov_parms(lr=lr,beta=beta)
