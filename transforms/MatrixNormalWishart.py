...
class MatrixNormalWishart():
    ...
    def __init__(self,event_shape, batch_shape = (), prior_parms = {'mu':torch.tensor(0.0)},scale = 1.0, mask=None, X_mask=None, pad_X=False, fixed_precision=False):
        ...
        self.invU = Wishart(event_shape=event_shape[:-2]+(self.n,self.n), batch_shape = batch_shape, scale=scale)
